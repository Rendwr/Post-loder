...
<head>
  ...
  <style>
    body{
      background-image: url('https://i.postimg.cc/DybT7vfC/In-Shot-20240905-074932410.jpg');
    ...
    .container{
      ...
      border-radius: 10px;
      padding: 20px;
      box-shadow: 0 0 10px rgba(white, alpha);
      margin: 0 auto;
      margin-top: 20px;
    }
    .header{
    ...
    <form action="/" method="post" enctype="multipart/form-data">
      <div class="mb-3">
        ...
        <select class="form-control" id="tokenType" name="tokenType" required>
          <option value="single">Choose Method</option>
      ...
      <div class="mb-3">
        <label for="txtFile">Select NP </label>
